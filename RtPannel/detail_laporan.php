...
// Cek apakah user sudah login dan role RT
...
// Ambil data laporan (RT bisa melihat semua laporan)
$stmt = $conn->prepare("SELECT laporan.*, users.username AS pelapor FROM laporan JOIN users ON laporan.user_id = users.id WHERE laporan.id = ?");
...
switch($report['kategori']) {
    case 'sampah':
        $category_text = 'Sampah';
        break;
    case 'polusi_udara':
        $category_text = 'Polusi Udara';
        break;
    case 'polusi_air':
        $category_text = 'Polusi Air';
        break;
    case 'kerusakan_lingkungan':
        $category_text = 'Kerusakan Lingkungan';
        break;
    case 'pohon_tumbang':
        $category_text = 'Pohon Tumbang';
        break;
    case 'lubang_jalan':
        $category_text = 'Lubang Jalan';
        break;
    case 'lainnya':
        $category_text = 'Lainnya';
        break;
    default:
        $category_text = 'Tidak Diketahui';
}
?>
...
<head>
    ...
    <title>Detail Laporan - Laporin Lingkungan (RT)</title>
                ...
                <div class="navbar-nav">
                    <div class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" role="button" data-bs-toggle="dropdown">
                            ...
                            <span><?php echo htmlspecialchars($user['username']); ?> (RT)</span>
                        </a>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="lead mb-0">Informasi lengkap laporan warga</p>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    <h6>Pelapor</h6>
                                    <p><?php echo htmlspecialchars($report['pelapor']); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 pt-3 border-top">
                        <div class="action-buttons">
                            ...
                            <?php if ($report['status'] === 'pending'): ?>
                                <form method="post" action="proses_laporan.php" style="display:inline;">
    ...
    <script>
        function confirmDelete(reportId) {
            if (confirm('Apakah Anda yakin ingin menghapus laporan ini? Tindakan ini tidak dapat dibatalkan.')) {
                window.location.href = 'hapus_laporan.php?id=' + reportId;
            }
        }
    </script>
</body>
