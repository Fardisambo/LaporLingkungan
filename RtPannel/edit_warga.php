...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("UPDATE warga SET username=?, alamat=?, nik=? WHERE id=?");
    $stmt->bind_param("sssi", $username, $alamat, $nik, $id);
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="nik" name="nik" 
                                           value="<?= $warga['nik'] ?>" placeholder="Masukkan NIK" required>
                                </div>
                            </div>
