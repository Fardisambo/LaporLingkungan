...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("UPDATE warga SET username=?, alamat=?, nis=? WHERE id=?");
    $stmt->bind_param("sssi", $username, $alamat, $nis, $id);
...
<head>
    ...
    <title>Edit Warga - Admin Dashboard</title>
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h1 class="fw-bold mb-2">
                            <i class="fas fa-edit me-3"></i>Edit Warga
                        </h1>
                        <p class="mb-0 opacity-75">Edit data warga yang sudah ada</p>
                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="username" name="username" 
                                           value="<?= $warga['username'] ?>" placeholder="Masukkan nama lengkap" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" id="alamat" name="alamat" rows="3" 
                                              placeholder="Masukkan alamat lengkap" required><?= $warga['alamat'] ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="nis" name="nis" 
                                           value="<?= $warga['nis'] ?>" placeholder="Masukkan NIS" required>
                                </div>
                            </div>
