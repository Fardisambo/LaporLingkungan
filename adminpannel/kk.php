...
<body>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <?php
            $total_kk = $conn->query("SELECT COUNT(*) as total FROM keluarga")->fetch_assoc()['total'];
            ?>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>
                                    ...
                                    <td class='align-middle'>{$row['kepala_keluarga']}</td>
                                    <td class='align-middle'>{$row['alamat']}</td>
                                    <td class='align-middle'>{$row['rt']}</td>
                                    <td class='align-middle'>{$row['rw']}</td>
                                    <td class='align-middle'>{$row['kelurahan']}</td>
                                    <td class='align-middle text-center'>
                                        <div class='btn-group' role='group'>
                                            <a href='edit_kk.php?id={$row['id']}' class='btn btn-sm btn-warning me-1' title='Edit'>
                                                <i class='fas fa-edit'></i>
                                            </a>
                                            <a href='hapus_kk.php?id={$row['id']}' class='btn btn-sm btn-danger' 
