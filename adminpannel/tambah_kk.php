...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO keluarga (no_kk, kepala_keluarga, alamat, rt, rw, kelurahan) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssss", $no_kk, $kepala_keluarga, $alamat, $rt, $rw, $kelurahan);
...
<head>
    ...
    <title>Tambah KK - Admin Dashboard</title>
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h1 class="fw-bold mb-2">
                            <i class="fas fa-user-plus me-3"></i>Tambah Kartu Keluarga
                        </h1>
                        <p class="mb-0 opacity-75">Tambah data kartu keluarga baru ke sistem</p>
                    </div>
