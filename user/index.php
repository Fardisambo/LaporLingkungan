...
// Get completed reports count (from all users)
...
<head>
    ...
    <title>Dashboard - Laporin Lingkungan</title>
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="display-6 fw-bold mb-2">
                        <i class="fas fa-sun me-2"></i>Selamat Datang!
                    </h1>
        ...
        <div class="welcome-card">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="lead mb-3">Platform pelaporan lingkungan yang memudahkan Anda melaporkan masalah lingkungan di sekitar Anda.</p>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-3 mb-3">
                <div class="action-card">
                    ...
                    <h5 class="fw-bold mb-2">Buat Laporan</h5>
                    <p class="text-muted mb-3">Laporkan masalah lingkungan yang Anda temukan</p>
                    <a href="buat_laporan.php" class="btn btn-primary w-100">
            ...
            <div class="col-md-6 col-lg-3 mb-3">
                <div class="action-card">
                    ...
                    <h5 class="fw-bold mb-2">Semua Laporan</h5>
                    <p class="text-muted mb-3">Lihat semua laporan dari semua pengguna</p>
                    <a href="laporan.php" class="btn btn-outline-primary w-100">
            ...
            <div class="col-md-6 col-lg-3 mb-3">
                <div class="action-card">
                    ...
                    <h5 class="fw-bold mb-2">Bantuan</h5>
                    <p class="text-muted mb-3">Panduan penggunaan aplikasi</p>
                    <a href="bantuan.php" class="btn btn-outline-primary w-100">
                        <i class="fas fa-arrow-right me-1"></i>Bantuan
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-5">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php
                        $stmt = $conn->prepare("SELECT l.*, u.username FROM laporan l JOIN users u ON l.user_id = u.id ORDER BY l.created_at DESC LIMIT 5");
                        $stmt->execute();
